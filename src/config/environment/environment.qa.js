 ...
 *
 * The build system defaults to the dev environment which uses `environment.qa.js`, but if you do
 * `npm start qa then `environment.qa.ts` will be used instead.
 */
...
export default {
   ...
   *
   * debug - If `true`, i18n will run on debug mode. By default set to false for qa env.
   */
  i18n: {
    debug: false
  },

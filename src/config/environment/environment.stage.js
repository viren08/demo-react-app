 ...
 *
 * The build system defaults to the dev environment which uses `environment.stage.js`, but if you do
 * `npm start stage then `environment.stage.ts` will be used instead.
 */
...
export default {
   ...
   *
   * debug - If `true`, i18n will run on debug mode. By default set to false for stage env.
   */
  i18n: {
    debug: false
  },
